...
class LikedImages {
  ...
  static Future<File> get _localFile async {
    ...
    return File('$path/imageList.json');
  }

  static Future<File> writeImageList(List<String> imagesList) async {
    final file = await _localFile;

    String stringifyImagesList = imagesList.join(',');
    // Write the file.
    return file.writeAsString(stringifyImagesList);
  }

  static Future<List<String>> readImageList() async {
    try {
      final file = await _localFile;

      // Read the file.
      String imageList = await file.readAsString();
